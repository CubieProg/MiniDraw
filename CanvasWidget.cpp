...
void CanvasWidget::mousePressEvent(QMouseEvent *event) {
    ...
    if (message == ToolMessage::ENTER){
        if (toolsContainer->GetActiveTool()->GetToolType() == ToolType::TextTool) {
            auto text_tool_ptr = std::static_pointer_cast<TextTool>(toolsContainer->GetActiveTool());
...
void CanvasWidget::mouseMoveEvent(QMouseEvent *event) {
    ...
    toolsContainer->GetActiveTool()->OnMove(event);
